        ...
        <b-card>
          ...
          <div slot="footer">
            <b-button
              ...
              size="sm"
              variant="primary"
            ><i class="fa fa-dot-circle-o" /> Submit</b-button>
            <b-button
              type="reset"
              size="sm"
              variant="danger"
            ><i class="fa fa-ban" /> Reset</b-button>
          </div>
        </b-card>
        <b-card>
          <div slot="header">
        ...
        >
          ...
          <div slot="footer">
            <b-button
              ...
              size="sm"
              variant="primary"
            ><i class="fa fa-user" /> Login</b-button>
            <b-button
              type="reset"
              size="sm"
              variant="danger"
        ...
        <b-card no-body>
          <div slot="header">
            ...
            <div class="card-actions">
              ...
              ><i class="icon-arrow-up" /></b-btn>
              <a
                href="#"
                class="btn btn-close"
              ><i class="icon-close" /></a>
            </div>
          </div>
          <b-collapse
            id="collapse1"
