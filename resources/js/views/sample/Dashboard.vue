      ...
      <b-row>
        ...
        >
          <b-button
            ...
            variant="primary"
            class="float-right"
          ><i class="icon-cloud-download" /></b-button>
          <b-button-toolbar
            class="float-right"
                ...
                <li>
                  ...
                  <div class="actions">
                    <b-button
                      variant="link"
                      class="text-muted"
                    ><i class="icon-settings" /></b-button>
                  </div>
                </li>
                <li>
...
import { Callout } from '@/components/coreui'
...
export default {
  ...
  methods: {
    variant (value) {
      let $variant
      if (value <= 25) { $variant = 'info' } else if (value > 25 && value <= 50) { $variant = 'success' } else if (value > 50 && value <= 75) { $variant = 'warning' } else if (value > 75 && value <= 100) { $variant = 'danger' }
